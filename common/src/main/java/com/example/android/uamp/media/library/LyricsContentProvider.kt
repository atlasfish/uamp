...
internal class LyricsContentProvider : ContentProvider() {
    ...
    companion object {
        ...
        fun mapUri(uri: Uri): Uri {
            ...
            val contentUri = Uri.Builder()
                ...
                .authority("com.example.android.uamp.lyrics")
                .path(contentPath)
                .build()
    ...
    override fun openFile(uri: Uri, mode: String): ParcelFileDescriptor? {
        ...
        if (!file.exists()) {
            ...
            for (i in 1..3) {
                try {
                    // Use Glide to download the lyrics file.
                    ...
                    if (e is java.util.concurrent.ExecutionException && e.cause is com.bumptech.glide.load.engine.GlideException) {
                        ...
                        glideException.logRootCauses("LyricsContentProvider - Attempt $i")
                    } else {
                        e.printStackTrace()
                    }
